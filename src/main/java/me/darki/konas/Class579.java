    ...
    public void Method174(String[] stringArray) {
        if (stringArray.length == this.Method189().size()) {
            if (stringArray[1].equalsIgnoreCase("list")) {
                if (((Class526)Spammer.Field791.getValue()).Method1225().isEmpty()) {
                    Logger.Method1118("You don't have any spammer files loaded");
                } else {
                    Logger.Method1118("Spammer Files:");
                    for (String string : ((Class526)Spammer.Field791.getValue()).Method1225()) {
        ...
        if (stringArray[1].equalsIgnoreCase("add")) {
            ...
            if (((Class526)Spammer.Field791.getValue()).Method1225().contains(string)) {
                Logger.Method1118("This Spammer File has already been added!");
                return;
            }
            ((Class526)Spammer.Field791.getValue()).Method1227(string);
            ...
            ((Class526)Spammer.Field791.getValue()).Method1228(string);
