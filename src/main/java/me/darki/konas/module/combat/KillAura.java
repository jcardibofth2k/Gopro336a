...
extends Module {
    ...
    public void onDisable() {
        if (KillAura.mc.player != null && ((Boolean)Field458.getValue()).booleanValue() && this.Field483 != -1) {
            KillAura.mc.player.inventory.currentItem = this.Field483;
            KillAura.mc.player.connection.sendPacket((Packet)new CPacketHeldItemChange(this.Field483));
            this.Field483 = -1;
        }
    }
    ...
    public void Method536(Class24 class24) {
        block2: {
            ...
            if (class24.getPacket() instanceof CPacketPlayer.Position) {
                ...
                KillAura.mc.player.connection.sendPacket((Packet)new CPacketPlayer.PositionRotation(cPacketPlayer.getX(KillAura.mc.player.posX), cPacketPlayer.getY(KillAura.mc.player.posY), cPacketPlayer.getZ(KillAura.mc.player.posZ), (float)Field480, (float)Field481, cPacketPlayer.isOnGround()));
            }
        }
    }

    public boolean Method395(Entity entity) {
        if (((Boolean)Field441.getValue()).booleanValue() && entity instanceof EntityAnimal) {
            return true;
        }
        if (((Boolean)Field442.getValue()).booleanValue() && entity instanceof IMob) {
            return true;
        }
        if (((Boolean)Field444.getValue()).booleanValue() && entity instanceof EntityPlayer) {
            if (!((Boolean)Field445.getValue()).booleanValue()) {
        ...
        block15: {
            ...
            if (Field448.getValue() != Class308.NONE && this.Field484 != null) {
                ...
                if (Field448.getValue() == Class308.HIT) {
                    ...
                    if (Field454.getValue() == Class311.STATIC && this.Field479 < (Integer)Field455.getValue()) {
                        ++this.Field479;
                    }
                    float f2 = 1.0f;
                    ...
                    if (this.Field485.Method737(5000.0) || Field480 == 0.0 || Field454.getValue() == Class311.DYNAMIC && KillAura.mc.player.getCooledAttackStrength(Field452.getValue() != Class327.NONE ? -f : 0.0f) >= f2 || Field454.getValue() == Class311.STATIC && this.Field479 >= (Integer)Field455.getValue()) {
                        this.Method561(this.Field484);
                    }
                } else {
                    this.Method561(this.Field484);
                }
                if (((Float)Field451.getValue()).floatValue() < 1.0f && Math.abs(f = (float)MathHelper.wrapDegrees((double)(Field480 - (double)((IEntityPlayerSP)KillAura.mc.player).Method238()))) > 180.0f * ((Float)Field451.getValue()).floatValue()) {
                    Field480 = ((IEntityPlayerSP)KillAura.mc.player).Method238() + f * (180.0f * ((Float)Field451.getValue()).floatValue() / Math.abs(f));
                    bl = false;
                }
    ...
    public boolean Method556(Entity entity, float f) {
        ...
        if (((Boolean)Field443.getValue()).booleanValue() && entity instanceof EntityShulkerBullet && !entity.isDead && this.Method560(entity, f) && KillAura.Method384(entity)) {
            return true;
        }
    ...
    public void Method557() {
        if (((Boolean)Field459.getValue()).booleanValue() && KillAura.mc.player.getActiveItemStack().getItem() instanceof ItemFood) {
            return;
        }
        float f = 0.0f;
        if (Field452.getValue() == Class327.NORMAL) {
        ...
        if (Field454.getValue() == Class311.DYNAMIC && KillAura.mc.player.getCooledAttackStrength(Field452.getValue() != Class327.NONE ? -f : 0.0f) >= f2 || Field454.getValue() == Class311.STATIC && this.Field479 >= (Integer)Field455.getValue()) {
            if (!this.Method556(this.Field484, ((Float)Field439.getValue()).floatValue())) {
                this.Field484 = null;
            }
        } else if (Field454.getValue() == Class311.STATIC && this.Field479 < (Integer)Field455.getValue()) {
            ++this.Field479;
        }
        if ((!((Boolean)Field463.getValue()).booleanValue() || KillAura.mc.player.motionY < 0.0) && (!((Boolean)Field464.getValue()).booleanValue() || KillAura.mc.world.getBlockState(new BlockPos((Entity)KillAura.mc.player)).getBlock() instanceof BlockAir) && (Field454.getValue() == Class311.DYNAMIC && KillAura.mc.player.getCooledAttackStrength(Field452.getValue() != Class327.NONE ? -f : 0.0f) >= f2 || Field454.getValue() == Class311.STATIC && this.Field479 >= (Integer)Field455.getValue())) {
            if (this.Field484 != null) {
                if (((Boolean)Field457.getValue()).booleanValue()) {
                    this.Method562(this.Method464());
                }
                boolean bl = KillAura.mc.player.isSneaking();
                boolean bl2 = (Boolean)Field450.getValue() != false && KillAura.mc.player.isSprinting();
                ...
                if (bl3 && KillAura.mc.player.getHeldItemOffhand().getItem() instanceof ItemShield) {
                    KillAura.mc.player.connection.sendPacket((Packet)new CPacketPlayerDigging(CPacketPlayerDigging.Action.RELEASE_USE_ITEM, new BlockPos((Entity)KillAura.mc.player), EnumFacing.getFacingFromVector((float)((int)KillAura.mc.player.posX), (float)((int)KillAura.mc.player.posY), (float)((int)KillAura.mc.player.posZ))));
                }
                KillAura.mc.playerController.attackEntity((EntityPlayer)KillAura.mc.player, this.Field484);
                ...
                if (bl3 && KillAura.mc.player.getHeldItemMainhand().getItem() instanceof ItemSword && KillAura.mc.player.getHeldItemOffhand().getItem() instanceof ItemShield) {
                    KillAura.mc.playerController.processRightClick((EntityPlayer)KillAura.mc.player, (World)KillAura.mc.world, EnumHand.OFF_HAND);
                }
            } else if (((Boolean)Field458.getValue()).booleanValue() && this.Field483 != -1) {
                KillAura.mc.player.inventory.currentItem = this.Field483;
                KillAura.mc.player.connection.sendPacket((Packet)new CPacketHeldItemChange(this.Field483));
                this.Field483 = -1;
            }
    ...
    public static boolean Method467(Vec3d vec3d) {
        ...
        return KillAura.mc.world.rayTraceBlocks(vec3d2, vec3d) == null || vec3d.distanceTo(KillAura.mc.player.getPositionEyes(1.0f)) <= (double)((Float)Field449.getValue()).floatValue();
    }
    ...
    public boolean Method388() {
            ...
            if (((Module)((Object)list)).isEnabled()) {
                if (((Boolean)Field466.getValue()).booleanValue()) {
                    if (autoCrystal.Method1554() != null || autoCrystal.Method1573() != null) {
                        this.Field484 = null;
                        if (((Boolean)Field458.getValue()).booleanValue() && this.Field483 != -1) {
                            KillAura.mc.player.inventory.currentItem = this.Field483;
                            KillAura.mc.player.connection.sendPacket((Packet)new CPacketHeldItemChange(this.Field483));
                            this.Field483 = -1;
                        }
        ...
        if (((Boolean)Field461.getValue()).booleanValue()) {
            if (!(KillAura.mc.player.getHeldItemMainhand().getItem() instanceof ItemSword)) {
                return false;
            }
            if (((Boolean)Field467.getValue()).booleanValue() && EnchantmentHelper.getEnchantmentLevel((Enchantment)Enchantments.SHARPNESS, (ItemStack)KillAura.mc.player.getHeldItemMainhand()) < 6) {
                this.Field484 = null;
                if (((Boolean)Field458.getValue()).booleanValue() && this.Field483 != -1) {
                    KillAura.mc.player.inventory.currentItem = this.Field483;
                    KillAura.mc.player.connection.sendPacket((Packet)new CPacketHeldItemChange(this.Field483));
        ...
        if (((Boolean)Field462.getValue()).booleanValue() && !Class545.Method1009((BlockPos)(list = new BlockPos((Entity)KillAura.mc.player)))) {
            this.Field484 = null;
            if (((Boolean)Field458.getValue()).booleanValue() && this.Field483 != -1) {
                KillAura.mc.player.inventory.currentItem = this.Field483;
                KillAura.mc.player.connection.sendPacket((Packet)new CPacketHeldItemChange(this.Field483));
        ...
        if (((Boolean)Field460.getValue()).booleanValue() && this.Field484 != null && !KillAura.mc.player.isActiveItemStackBlocking() && KillAura.mc.player.getHeldItemOffhand().getItem() instanceof ItemShield) {
            KillAura.mc.playerController.processRightClick((EntityPlayer)KillAura.mc.player, (World)KillAura.mc.world, EnumHand.OFF_HAND);
        }
        return true;
    }
    ...
    public static boolean Method393() {
        return (Boolean)Field461.getValue();
    }
    ...
    public boolean Method513(Entity entity) {
        return this.Method556(entity, ((Float)Field439.getValue()).floatValue());
    }
            ...
            for (d2 = 0.15; d2 < 0.85; d2 += 0.1) {
                for (d = 0.15; d < 0.85; d += 0.1) {
                    for (double d3 = 0.15; d3 < 0.85; d3 += 0.1) {
                        ...
                        double[] dArray2 = new double[]{MathHelper.wrapDegrees((float)((float)Math.toDegrees(Math.atan2(d6, d4)) - 90.0f)), MathHelper.wrapDegrees((float)((float)(-Math.toDegrees(Math.atan2(d5, Math.sqrt(d4 * d4 + d6 * d6))))))};
    ...
    public void Method562(int n) {
        block1: {
            ...
            if (((Boolean)Field458.getValue()).booleanValue()) {
                this.Field483 = KillAura.mc.player.inventory.currentItem;
            }
            KillAura.mc.player.inventory.currentItem = n;
            KillAura.mc.player.connection.sendPacket((Packet)new CPacketHeldItemChange(n));
        }
    }
    ...
    public void Method139(Class89 class89) {
        block10: {
            ...
            if (!((Boolean)Field469.getValue()).booleanValue() || this.Field484 == null || ((Boolean)Field470.getValue()).booleanValue() && this.Field485.Method737(3500.0)) break block10;
            GlStateManager.pushMatrix();
            Class507.Method1386();
            if (((Boolean)Field471.getValue()).booleanValue()) {
                GlStateManager.enableDepth();
            }
            IRenderManager iRenderManager = (IRenderManager)mc.getRenderManager();
            float[] fArray = Color.RGBtoHSB(((ColorValue)Field478.getValue()).Method769(), ((ColorValue)Field478.getValue()).Method770(), ((ColorValue)Field478.getValue()).Method779(), null);
            ...
            double d4 = -Math.cos((double)(System.currentTimeMillis() - this.Field482) / 1000.0 * (double)((Float)Field476.getValue()).floatValue()) * ((double)this.Field484.height / 2.0) + (double)this.Field484.height / 2.0;
            GL11.glLineWidth((float)((Float)Field477.getValue()).floatValue());
            GL11.glBegin((int)1);
            for (n3 = 0; n3 <= 360; ++n3) {
            ...
            for (n3 = 0; n3 < arrayList.size() - 1; ++n3) {
                ...
                n2 = n4 >> 8 & 0xFF;
                n = n4 & 0xFF;
                float f4 = ((Boolean)Field473.getValue()).booleanValue() ? (((Boolean)Field474.getValue()).booleanValue() ? (float)Math.max(0.0, -0.3183098861837907 * Math.atan(Math.tan(Math.PI * (double)((float)n3 + 1.0f) / (double)arrayList.size() + (double)System.currentTimeMillis() / 1000.0 * (double)((Float)Field475.getValue()).floatValue()))) : (float)Math.max(0.0, Math.abs(Math.sin((double)(((float)n3 + 1.0f) / (float)arrayList.size()) * Math.PI + (double)System.currentTimeMillis() / 1000.0 * (double)((Float)Field475.getValue()).floatValue())) * 2.0 - 1.0)) : (f3 = (Boolean)Field472.getValue() != false ? 1.0f : (float)((ColorValue)Field478.getValue()).Method782() / 255.0f);
                if (((ColorValue)Field478.getValue()).Method783()) {
                    GL11.glColor4f((float)((float)n5 / 255.0f), (float)((float)n2 / 255.0f), (float)((float)n / 255.0f), (float)f3);
                } else {
                    GL11.glColor4f((float)((float)((ColorValue)Field478.getValue()).Method769() / 255.0f), (float)((float)((ColorValue)Field478.getValue()).Method770() / 255.0f), (float)((float)((ColorValue)Field478.getValue()).Method779() / 255.0f), (float)f3);
                }
            ...
            GL11.glEnd();
            if (((Boolean)Field472.getValue()).booleanValue()) {
                f2 = f;
                GL11.glBegin((int)9);
                for (n3 = 0; n3 < arrayList.size() - 1; ++n3) {
                    int n6 = n4 >> 16 & 0xFF;
                    ...
                    n = n4 & 0xFF;
                    if (((ColorValue)Field478.getValue()).Method783()) {
                        GL11.glColor4f((float)((float)n6 / 255.0f), (float)((float)n2 / 255.0f), (float)((float)n / 255.0f), (float)((float)((ColorValue)Field478.getValue()).Method782() / 255.0f));
                    } else {
                        GL11.glColor4f((float)((float)((ColorValue)Field478.getValue()).Method769() / 255.0f), (float)((float)((ColorValue)Field478.getValue()).Method770() / 255.0f), (float)((float)((ColorValue)Field478.getValue()).Method779() / 255.0f), (float)((float)((ColorValue)Field478.getValue()).Method782() / 255.0f));
                    }
                    GL11.glVertex3d((double)((Vec3d)arrayList.get((int)n3)).x, (double)((Vec3d)arrayList.get((int)n3)).y, (double)((Vec3d)arrayList.get((int)n3)).z);
                    GL11.glVertex3d((double)((Vec3d)arrayList.get((int)(n3 + 1))).x, (double)((Vec3d)arrayList.get((int)(n3 + 1))).y, (double)((Vec3d)arrayList.get((int)(n3 + 1))).z);
                    n4 = Color.getHSBColor(f2 += 0.0027777778f, fArray[1], fArray[2]).getRGB();
