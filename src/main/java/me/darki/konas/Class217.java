...
extends Class215 {
    ...
    public boolean Method494(int n, int n2, int n3) {
        block2: {
            ...
            if (n3 == 1) {
                NewGui.INSTANCE.Field1131.Method1828().Method2175().get((Object)this.Field390.Method1639()).Method2170(this.Field390);
            }
        }
    ...
    public void Method497(int n, int n2, float f) {
        ...
        if (NewGui.INSTANCE.Field1131.Method1828().Method2175().get((Object)this.Field390.Method1639()).Method2179() != null && NewGui.INSTANCE.Field1131.Method1828().Method2175().get((Object)this.Field390.Method1639()).Method2179().equals(this.Field390)) {
