...
extends Element {
    ...
    public void onRender2D() {
        ...
        Class557.Method801(string, (float)((int)this.Method2320() + (int)this.Method2329()) - Class557.Method800(string), (int)this.Method2324(), ((ColorValue)this.Field873.getValue()).Method774());
    }
