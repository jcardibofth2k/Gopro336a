...
import me.darki.konas.Class498;
import me.darki.konas.Class504;
import me.darki.konas.Class515;
...
implements Class515 {
    ...
    public Minecraft Field1360 = Minecraft.getMinecraft();
    ...
    public boolean Method1415(BlockPos blockPos) {
        Block block = this.Field1360.world.getBlockState(blockPos).getBlock();
    ...
    public boolean Method1417(BlockPos blockPos) {
        if (!this.Field1360.world.isBlockLoaded(blockPos)) {
            return false;
        }
        Material material = this.Field1360.world.getBlockState(blockPos).getMaterial();
        Block block = this.Field1360.world.getBlockState(blockPos).getBlock();
    ...
    public float Method1418(BlockPos blockPos, BlockPos blockPos2) {
        ...
        for (int i = 0; i < blockPosArray.length; ++i) {
            Material material = this.Field1360.world.getBlockState(blockPosArray[i]).getMaterial();
            ...
            if (!(this.Field1360.world.getBlockState(blockPosArray[i].down()).getBlock() instanceof BlockSoulSand)) continue;
            int n = i;
    ...
    public ArrayList<Class498> Method1422() {
        this.Field1361 = new Class498(new BlockPos(this.Field1360.player.posX, this.Field1360.player.onGround ? this.Field1360.player.posY + 0.5 : this.Field1360.player.posY, this.Field1360.player.posZ));
    ...
    public Class501(BlockPos blockPos, String string) {
        this.Field1361 = new Class498(new BlockPos(this.Field1360.player.posX, this.Field1360.player.onGround ? this.Field1360.player.posY + 0.5 : this.Field1360.player.posY, this.Field1360.player.posZ));
