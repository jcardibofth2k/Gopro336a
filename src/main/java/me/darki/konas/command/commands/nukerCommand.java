    ...
    public void Method174(String[] stringArray) {
        if (stringArray.length == 2) {
            if (stringArray[1].equalsIgnoreCase("list")) {
                if (!((Class443)Class319.Field740.getValue()).Method684().isEmpty()) {
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("\n");
                    ((Class443)Class319.Field740.getValue()).Method684().forEach(arg_0 -> nukerCommand.Method175(stringBuilder, arg_0));
        ...
        if (stringArray[1].equalsIgnoreCase("add")) {
            if (((Class443)Class319.Field740.getValue()).Method681(stringArray[2])) {
            ...
            if (((Class443)Class319.Field740.getValue()).Method677(stringArray[2])) {
        ...
        ((Class443)Class319.Field740.getValue()).Method680();
    }
