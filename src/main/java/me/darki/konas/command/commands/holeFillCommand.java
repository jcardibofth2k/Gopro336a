    ...
    public void Method174(String[] stringArray) {
        if (stringArray.length == 2) {
            if (stringArray[1].equalsIgnoreCase("list")) {
                if (!((Class443)HoleFill.Field1041.getValue()).Method684().isEmpty()) {
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("\n");
                    ((Class443)HoleFill.Field1041.getValue()).Method684().forEach(arg_0 -> holeFillCommand.Method175(stringBuilder, arg_0));
        ...
        if (stringArray[1].equalsIgnoreCase("add")) {
            if (((Class443)HoleFill.Field1041.getValue()).Method681(stringArray[2])) {
            ...
            if (((Class443)HoleFill.Field1041.getValue()).Method677(stringArray[2])) {
        ...
        ((Class443)HoleFill.Field1041.getValue()).Method680();
    }
}
