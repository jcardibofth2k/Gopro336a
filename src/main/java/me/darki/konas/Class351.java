...
extends Module {
    ...
    public static Float Method520(EntityPlayer entityPlayer) {
        return Float.valueOf(Class351.mc.player.getDistance(entityPlayer));
    }
    ...
    public static boolean Method138(EntityPlayer entityPlayer) {
        return entityPlayer.getDistance(Class351.mc.player) < 10.0f;
    }
    ...
    public void Method135(UpdateEvent updateEvent) {
        ...
        this.Field2533 = Field2529.getValue() == Class364.SPIN ? (this.Field2533 += (float) Field2531.getValue().intValue()) : (Field2529.getValue() == Class364.JITTER ? (Math.random() > 0.5 ? (float)((double)this.Field2533 + (double) Field2531.getValue().intValue() * Math.random()) : (float)((double)this.Field2533 - (double) Field2531.getValue().intValue() * Math.random())) : ((entityPlayer = this.Method1054()) != null ? RotationUtil.Method1946(Class351.mc.player.getPositionEyes(1.0f), entityPlayer.getPositionEyes(1.0f))[0] - 180.0f : Class351.mc.player.rotationYaw));
        this.Field2533 += (float) Field2532.getValue().intValue();
        this.Field2533 = MathHelper.wrapDegrees((int)this.Field2533);
        this.Field2534 = Field2530.getValue() == Class353.NONE ? Class351.mc.player.rotationPitch : (Field2530.getValue() == Class353.JITTER ? (Math.random() > 0.5 ? (float)((double)this.Field2534 + (double) Field2531.getValue().intValue() * Math.random()) : (float)((double)this.Field2534 - (double) Field2531.getValue().intValue() * Math.random())) : (Field2530.getValue() == Class353.STARE ? ((entityPlayer = this.Method1054()) != null ? RotationUtil.Method1946(Class351.mc.player.getPositionEyes(1.0f), entityPlayer.getPositionEyes(1.0f))[1] : Class351.mc.player.rotationPitch) : 90.0f));
