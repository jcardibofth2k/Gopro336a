...
extends Module {
    ...
    public void Method462(TickEvent tickEvent) {
        block1: {
            ...
            if (!this.Field1282.getValue().booleanValue()) break block1;
    ...
    public void Method139(Class89 class89) {
        ...
        GlStateManager.depthMask(false);
        GlStateManager.color((float) this.Field1281.getValue().Method775().getRed() / 255.0f, (float) this.Field1281.getValue().Method775().getGreen() / 255.0f, (float) this.Field1281.getValue().Method775().getBlue() / 255.0f, (float) this.Field1281.getValue().Method775().getAlpha() / 255.0f);
    ...
    public void Method1255(Integer n, Class508 class508) {
        if (System.currentTimeMillis() - class508.Method1363() > 1000L * (long) this.Field1283.getValue().intValue()) {
