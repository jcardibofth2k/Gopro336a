...
extends Module {
    public static Setting<Float> Field2270 = new Setting<>("Delay", Float.valueOf(0.1f), Float.valueOf(5.0f), Float.valueOf(0.0f), Float.valueOf(0.1f));
    public static Setting<Float> Field2271 = new Setting<>("Reach", Float.valueOf(4.2f), Float.valueOf(6.0f), Float.valueOf(1.0f), Float.valueOf(0.1f));
    public static Setting<Boolean> Field2272 = new Setting<>("Rotate", false);
    public static Setting<Boolean> Field2273 = new Setting<>("AutoSwap", false);
    public static Setting<Boolean> Field2274 = new Setting<>("Queue", false);
    public static Setting<Boolean> Field2275 = new Setting<>("Render", false);
    public Setting<ColorValue> Field2276 = new Setting<>("Queue", new ColorValue(0x550000FF)).Method1191(Field2275::getValue);
    public Setting<ColorValue> Field2277 = new Setting<>("QueueOutline", new ColorValue(Color.BLUE.hashCode())).Method1191(Field2275::getValue);
    public Setting<ColorValue> Field2278 = new Setting<>("Mining", new ColorValue(0x55FF0000)).Method1191(Field2275::getValue);
    public Setting<ColorValue> Field2279 = new Setting<>("MiningOutline", new ColorValue(Color.RED.hashCode())).Method1191(Field2275::getValue);
    public Setting<ColorValue> Field2280 = new Setting<>("Ready", new ColorValue(0x5500FF00)).Method1191(Field2275::getValue);
    public Setting<ColorValue> Field2281 = new Setting<>("ReadyOutline", new ColorValue(Color.GREEN.hashCode())).Method1191(Field2275::getValue);
    public Setting<Float> Field2282 = new Setting<>("Width", Float.valueOf(1.5f), Float.valueOf(10.0f), Float.valueOf(0.0f), Float.valueOf(0.1f)).Method1191(Field2275::getValue);
