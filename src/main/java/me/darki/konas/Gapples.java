...
extends Element {
    public Setting<ColorValue> Field2093 = new Setting<>("TextColor", new ColorValue(new Color(255, 85, 255, 255).hashCode(), false));
    ...
    public void onRender2D() {
        ...
        Class557.Method801(string, (float)((int)this.Method2320() + (int)this.Method2329()) - Class557.Method800(string), (int)this.Method2324(), ((ColorValue)this.Field2093.getValue()).Method774());
    }
