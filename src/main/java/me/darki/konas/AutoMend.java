...
extends Module {
    ...
    public Setting<Float> crystalRange = new Setting<>("CrystalRange", Float.valueOf(6.0f), Float.valueOf(10.0f), Float.valueOf(0.0f), Float.valueOf(0.1f)).Method1191(this.attackCheck::getValue);
