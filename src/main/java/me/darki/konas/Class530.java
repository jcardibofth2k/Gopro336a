...
extends Setting {
    ...
    public void Method1154(String string) {
        block0: {
            ...
            this.Field1148.Method630(this.Method1198(string));
        }
    }
    ...
    public Class530(String string, T t, T t2, T t3, T t4, @NotNull Class529<T> class529) {
        super(string, t, t2, t3, t4);
        this.Field1148 = class529;
    }

    public Class530(String string, T t, @NotNull Class529<T> class529) {
        super(string, t);
        this.Field1148 = class529;
    }
}
