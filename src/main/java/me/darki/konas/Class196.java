...
extends Class90 {
    ...
    public void Method101(int n, int n2, float f) {
        ...
        int n3 = ClickGUIModule.color.getValue().Method774();
        if (ClickGUIModule.hover.getValue().booleanValue() && Class196.Method916(n, n2, this.Method922(), this.Method921(), this.Method910(), this.Method911())) {
            n3 = ClickGUIModule.color.getValue().Method775().brighter().hashCode();
        }
        RenderUtil2.Method1338(this.Method922() - 2.0f, this.Method921() - 2.0f, this.Method910() + 4.0f, this.Method911() + 4.0f, ClickGUIModule.secondary.getValue().Method774());
