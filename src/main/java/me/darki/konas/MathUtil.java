...
public class MathUtil {
    public static Minecraft Field1066 = Minecraft.getMinecraft();
    ...
    public static Vec3d Method1078() {
        return new Vec3d(MathUtil.Field1066.player.posX, MathUtil.Field1066.player.posY + (double) MathUtil.Field1066.player.getEyeHeight(), MathUtil.Field1066.player.posZ);
    }

    public static boolean Method1079() {
        return MathUtil.Field1066.gameSettings.keyBindForward.isKeyDown() && !MathUtil.Field1066.player.isSneaking();
    }

    public static boolean Method1080() {
        return MathUtil.Field1066.gameSettings.keyBindForward.isKeyDown() || MathUtil.Field1066.gameSettings.keyBindBack.isKeyDown() || MathUtil.Field1066.gameSettings.keyBindRight.isKeyDown() || MathUtil.Field1066.gameSettings.keyBindLeft.isKeyDown();
    }
    ...
    public static boolean Method1084() {
        boolean bl = false;
        if (MathUtil.Field1066.player.posY <= 0.0) {
            return true;
        }
        int n = 1;
    ...
    public static float[] Method1085(Vec3d vec3d) {
        Vec3d vec3d2 = MathUtil.Method1078();
    ...
    public static double[] Method1086(double d) {
        float f = MathUtil.Field1066.player.movementInput.moveForward;
        float f2 = MathUtil.Field1066.player.movementInput.moveStrafe;
        float f3 = MathUtil.Field1066.player.prevRotationYaw + (MathUtil.Field1066.player.rotationYaw - MathUtil.Field1066.player.prevRotationYaw) * Field1066.getRenderPartialTicks();
        if (f != 0.0f) {
            if (f2 > 0.0f) {
                f3 += (float)(f > 0.0f ? -45 : 45);
            } else if (f2 < 0.0f) {
    ...
    public static double[] Method1089(float f) {
        double d = MathUtil.Method1082(f);
    ...
    public static void Method1091(boolean bl) {
        ((IEntity) MathUtil.Field1066.player).Method43(7, bl);
    }
}
