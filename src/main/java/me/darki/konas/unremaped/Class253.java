...
extends Class215 {
    ...
    public boolean Method494(int n, int n2, int n3) {
        if (Class253.Method487(n, n2, this.Method486(), this.Method492() + (this.Field2173.hasDescription() ? 34.0f : 18.0f), this.Method489(), 20.0)) {
            if (n3 == 0) {
                ...
                int n4 = this.Field2173.Method1195(this.Field2173.getValue().toString());
                if (this.Method1974(n4 + 1)) {
                    this.Field2173.setValue(((Enum[]) this.Field2173.getValue().getClass().getEnumConstants())[n4 + 1]);
                } else {
                    this.Field2173.setValue(((Enum[]) this.Field2173.getValue().getClass().getEnumConstants())[0]);
                }
            }
            return true;
        }
        if (this.Field2174) {
            ...
            for (int i = 0; i <= this.Field2173.getValue().getClass().getEnumConstants().length - 1; ++i) {
                Enum enum_ = ((Enum[]) this.Field2173.getValue().getClass().getEnumConstants())[i];
                if (enum_.name().equalsIgnoreCase(this.Field2173.getValue().toString())) continue;
    ...
    public void Method477(int n, int n2, float f) {
        ...
        if (this.Field2174) {
            ...
            for (int i = 0; i <= this.Field2173.getValue().getClass().getEnumConstants().length - 1; ++i) {
                Enum enum_ = ((Enum[]) this.Field2173.getValue().getClass().getEnumConstants())[i];
                if (enum_.name().equalsIgnoreCase(this.Field2173.getValue().toString())) continue;
                boolean bl = i == this.Field2173.getValue().getClass().getEnumConstants().length - 1 || i == this.Field2173.getValue().getClass().getEnumConstants().length - 2 && ((Enum[]) this.Field2173.getValue().getClass().getEnumConstants())[i + 1].name().equalsIgnoreCase(this.Field2173.getValue().toString());
                Class270 class270 = new Class270(this.Method486(), this.Method492() + f2, this.Method489(), 20.0f, 3.0f, 25, bl ? 12 : 0);
                Class247.Method2043(class270, Class253.Method487(n, n2, this.Method486(), this.Method492() + f2, this.Method489(), 20.0) ? Field320.Method2048(KonasGui.highlight.getValue().floatValue()) : Field320);
    ...
    public boolean Method1974(int n) {
        return n <= this.Field2173.getValue().getClass().getEnumConstants().length - 1 && n >= 0;
    }
    ...
    public void Method497(int n, int n2, float f) {
        ...
        Class247.Method2043(class270, Class253.Method487(n, n2, this.Method486(), this.Method492() + (float)(this.Field2173.hasDescription() ? 34 : 18), this.Method489(), 20.0) ? Field320.Method2048(KonasGui.highlight.getValue().floatValue()) : Field320);
        ...
        Class247.Field2262.Method863(this.Field2173.getValue().toString(), (int)(this.Method486() + 6.0f), (int)(this.Method492() + (this.Field2173.hasDescription() ? 43.5f : 27.5f) - Class247.Field2262.Method831(this.Field2173.getValue().toString()) / 2.0f), Field325);
    }
}
