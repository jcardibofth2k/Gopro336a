...
extends Class215 {
    ...
    public void Method497(int n, int n2, float f) {
        ...
        Class247.Method2043(class270, Class222.Method487(n, n2, this.Method486(), this.Method492() + (float)(this.Field2634.hasDescription() ? 34 : 18), 132.0, 20.0) ? Field320.Method2048(((Float) KonasGui.highlight.getValue()).floatValue()) : Field320);
