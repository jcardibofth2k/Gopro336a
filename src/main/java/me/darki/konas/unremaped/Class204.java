...
extends Class183 {
    ...
    public void Method105(int n, int n2, float f) {
        ...
        int n3 = Class204.Method1493(n, n2, this.Method1475(), this.Method1476(), this.Method1479(), this.Method1481()) ? new Color(96, 96, 96, 100).hashCode() : ((ColorValue) ClickGUIModule.secondary.getValue()).Method774();
