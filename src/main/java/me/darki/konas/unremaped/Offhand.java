...
extends Module {
    ...
    public Setting<Float> delay = new Setting<>("Delay", Float.valueOf(0.0f), Float.valueOf(5.0f), Float.valueOf(0.0f), Float.valueOf(0.05f));
    public Setting<Boolean> hotbarTotem = new Setting<>("HotbarTotem", false);
    public Setting<Float> totemHealth = new Setting<>("TotemHealth", Float.valueOf(5.0f), Float.valueOf(36.0f), Float.valueOf(0.0f), Float.valueOf(0.5f));
    ...
    public Setting<Float> crystalRange = new Setting<>("CrystalRange", Float.valueOf(10.0f), Float.valueOf(15.0f), Float.valueOf(1.0f), Float.valueOf(1.0f)).visibleIf(this::Method388);
    public Setting<Boolean> fallCheck = new Setting<>("FallCheck", true);
    public Setting<Float> fallDist = new Setting<>("FallDist", Float.valueOf(15.0f), Float.valueOf(50.0f), Float.valueOf(0.0f), Float.valueOf(1.0f)).visibleIf(this::Method393);
    ...
    public float Method385(BlockPos blockPos) {
        ...
        for (Entity entity : list) {
            f += Class475.Method2150(entity.posX, entity.posY, entity.posZ, (Entity) Offhand.mc.player);
        }
        return f;
    }
