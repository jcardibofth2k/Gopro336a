...
public class Class475
{
    ...
    public static boolean Method2141(final double n, final double n2, final double n3) {
        return Class475.Field2499.world.rayTraceBlocks(new Vec3d(Class475.Field2499.player.posX, Class475.Field2499.player.posY + Class475.Field2499.player.getEyeHeight(), Class475.Field2499.player.posZ), new Vec3d(n, n2 + 1.8, n3), false, true, false) == null || Class475.Field2499.world.rayTraceBlocks(new Vec3d(Class475.Field2499.player.posX, Class475.Field2499.player.posY + Class475.Field2499.player.getEyeHeight(), Class475.Field2499.player.posZ), new Vec3d(n, n2 + 1.5, n3), false, true, false) == null || Class475.Field2499.world.rayTraceBlocks(new Vec3d(Class475.Field2499.player.posX, Class475.Field2499.player.posY + Class475.Field2499.player.getEyeHeight(), Class475.Field2499.player.posZ), new Vec3d(n, n2, n3), false, true, false) == null;
    }
    
    public static int Method2142() {
        if (Class475.Field2499.getConnection() == null) {
            return 50;
        }
        if (Class475.Field2499.player == null) {
            return 50;
        }
        try {
            return Class475.Field2499.getConnection().getPlayerInfo(Class475.Field2499.player.getUniqueID()).getResponseTime();
        }
    ...
    public static boolean Method2143(final Vec3d vec3d) {
        return Class475.Field2499.world.rayTraceBlocks(new Vec3d(Class475.Field2499.player.posX, Class475.Field2499.player.getEntityBoundingBox().minY + Class475.Field2499.player.getEyeHeight(), Class475.Field2499.player.posZ), vec3d) == null;
    }
    ...
    public static Vec3d Method2144(final Entity entity, final int n) {
        ...
        if (AutoCrystal.collision.getValue()) {
            for (int n6 = 1; n6 <= n && Class475.Field2499.world.getBlockState(new BlockPos(entity.posX + n2 * n6, entity.posY, entity.posZ + n3 * n6)).getBlock() instanceof BlockAir; ++n6) {
                n4 = n2 * n6;
                n5 = n3 * n6;
            }
        }
    ...
    public static boolean Method2145(final BlockPos blockPos) {
        ...
        try {
            if (Class475.Field2499.world.getBlockState(blockPos).getBlock() != Blocks.BEDROCK && Class475.Field2499.world.getBlockState(blockPos).getBlock() != Blocks.OBSIDIAN) {
                return false;
            }
    ...
    public static RayTraceResult Method2148(Vec3d vec3d, final Vec3d vec3d2, final boolean b, final boolean b2, final boolean b3) {
        ...
        if (!Double.isNaN(vec3d2.x) && !Double.isNaN(vec3d2.y) && !Double.isNaN(vec3d2.z)) {
            ...
            IBlockState blockState = Class475.Field2499.world.getBlockState(blockPos);
            Block block = blockState.getBlock();
            if (!Class475.Field2500.contains(block)) {
                block = Blocks.AIR;
                ...
                if (!Double.isNaN(vec3d.x)) {
                    if (!Double.isNaN(vec3d.y)) {
                        if (!Double.isNaN(vec3d.z)) {
                            ...
                            IBlockState blockState2 = Class475.Field2499.world.getBlockState(blockPos2);
                            Block block2 = blockState2.getBlock();
                            if (!Class475.Field2500.contains(block2)) {
                                block2 = Blocks.AIR;
    ...
    public static boolean Method2151(final BlockPos blockPos) {
        if (AutoCrystal.interact.getValue() != ACInteractMode.VANILLA) {
            ...
            final Vec3d vec3d = new Vec3d(Class475.Field2499.player.posX, Class475.Field2499.player.getEntityBoundingBox().minY + Class475.Field2499.player.getEyeHeight(), Class475.Field2499.player.posZ);
    ...
    static {
        Class475.Field2499 = Minecraft.getMinecraft();
