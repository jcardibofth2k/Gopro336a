...
extends Class215 {
    ...
    public void Method497(int n, int n2, float f) {
        ...
        Class247.Method2043(class270, Class228.Method487(n, n2, this.Method486(), this.Method492(), 18.0, 18.0) ? Field321.Method2048(KonasGui.highlight.getValue().floatValue()) : Field321);
        Class247.Method2042(class270, Field317, 1.0f);
        if (this.Field2624.getValue().booleanValue()) {
    ...
    public boolean Method494(int n, int n2, int n3) {
        if (Class228.Method487(n, n2, this.Method486(), this.Method492(), 18.0, 18.0) && n3 == 0) {
            this.Field2624.setValue(Boolean.valueOf(this.Field2624.getValue() == false));
            return true;
        }
