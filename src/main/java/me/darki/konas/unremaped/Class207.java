...
extends Class183 {
    ...
    public boolean Method106(int n, int n2, int n3) {
        ...
        if (Class207.Method1493(n, n2, this.Method1475(), this.Method1476(), this.Method1475() + this.Method1479(), this.Method1481()) && n3 == 0) {
            this.Method104(true);
            return true;
        }
        return false;
    ...
    public void Method649(int n, int n2, int n3, long l) {
        block0: {
            if (Class207.Method1493(n, n2, this.Method1475(), this.Method1476(), this.Method1475() + this.Method1479(), this.Method1481())) break block0;
            this.Method104(false);
        }
    }
}
