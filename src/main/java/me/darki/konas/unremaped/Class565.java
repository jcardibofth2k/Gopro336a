...
public class Class565 {
    ...
    public void Method747(TickEvent tickEvent) {
        if (Minecraft.getMinecraft().world == null || Minecraft.getMinecraft().player == null) {
            ((ITimer)((IMinecraft)Minecraft.getMinecraft()).Method56()).Method97(50.0f);
            return;
        }
        if (this.Field710 && (double)Class473.Field2557.Method2190() > 0.125) {
            ((ITimer)((IMinecraft)Minecraft.getMinecraft()).Method56()).Method97(Math.min(500.0f, 50.0f * (20.0f / Class473.Field2557.Method2190())));
            return;
        }
        ((ITimer)((IMinecraft)Minecraft.getMinecraft()).Method56()).Method97(this.Field709 ? 50.0f / this.Field708 : 50.0f);
    }
