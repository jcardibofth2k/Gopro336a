...
extends Element {
    ...
    public void onRender2D() {
        ...
        for (n3 = 9; n3 < n4; ++n3) {
            ...
            mc.getRenderItem().renderItemAndEffectIntoGUI((ItemStack)Class111.mc.player.inventory.mainInventory.get(n3), n2, n);
            mc.getRenderItem().renderItemOverlays(Class111.mc.fontRenderer, (ItemStack)Class111.mc.player.inventory.mainInventory.get(n3), n2, n);
