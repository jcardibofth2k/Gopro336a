...
extends Module {
    ...
    public void Method536(Class24 class24) {
        block0: {
            if (!((Boolean)this.Field1855.getValue() != false && class24.getPacket() instanceof CPacketInput || (Boolean)this.Field1856.getValue() != false && class24.getPacket() instanceof CPacketPlayer && Class273.mc.player.getRidingEntity() == null || (Boolean)this.Field1857.getValue() != false && class24.getPacket() instanceof CPacketEntityAction || (Boolean)this.Field1858.getValue() != false && class24.getPacket() instanceof CPacketUseEntity) && (!((Boolean)this.Field1859.getValue()).booleanValue() || !(class24.getPacket() instanceof CPacketVehicleMove))) break block0;
            class24.Cancel();
            ++this.Field1860;
