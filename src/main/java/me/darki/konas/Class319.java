...
extends Module {
    ...
    public static Setting<Class443> Field740 = new Setting<>("ValidBlocks", new Class443());
            ...
            for (double d = 0.1; d < 0.9; d += 0.1) {
                for (double d2 = 0.1; d2 < 0.9; d2 += 0.1) {
                    for (double d3 = 0.1; d3 < 0.9; d3 += 0.1) {
                        ...
                        Vec3d vec3d3 = new Vec3d(blockPos).add(d, d2, d3);
                        ...
                        double[] dArray2 = new double[]{MathHelper.wrapDegrees((float)Math.toDegrees(Math.atan2(d7, d5)) - 90.0f), MathHelper.wrapDegrees((float)(-Math.toDegrees(Math.atan2(d6, d8))))};
                        float f = MathHelper.cos((float)(-dArray2[0] * 0.01745329238474369 - 3.1415927410125732));
                        float f2 = MathHelper.sin((float)(-dArray2[0] * 0.01745329238474369 - 3.1415927410125732));
                        float f3 = -MathHelper.cos((float)(-dArray2[1] * 0.01745329238474369));
                        float f4 = MathHelper.sin((float)(-dArray2[1] * 0.01745329238474369));
                        Vec3d vec3d4 = new Vec3d(f2 * f3, f4, f * f3);
    ...
    public BlockPos Method790(boolean bl) {
        ...
        for (float f2 = f = this.Field736.getValue().floatValue(); f2 >= -f; f2 -= 1.0f) {
            for (float f3 = f; f3 >= -f; f3 -= 1.0f) {
                for (float f4 = f; f4 >= -f; f4 -= 1.0f) {
                    ...
                    if (this.Field739.getValue().booleanValue() && !Field740.getValue().Method682().contains(iBlockState.getBlock()) || !((d = Class319.mc.player.getDistance(blockPos2.getX(), blockPos2.getY(), blockPos2.getZ())) <= (double)f) || Class319.mc.world.getBlockState(blockPos2).getBlock() == Blocks.AIR || iBlockState.getBlock() instanceof BlockLiquid || !this.Method512(blockPos2) || bl && (this.Field741 == null || !Class319.mc.world.getBlockState(blockPos2).getBlock().equals(this.Field741)) || (double)blockPos2.getY() < Class319.mc.player.posY && !this.Field737.getValue().booleanValue()) continue;
                    f = (float)d;
                    blockPos = blockPos2;
                }
            }
    ...
    public void Method462(TickEvent tickEvent) {
        block8: {
            ...
            BlockPos blockPos = null;
            switch (Class336.Field328[this.Field734.getValue().ordinal()]) {
                case 1: {
            ...
            if (this.Field738.getValue().booleanValue() && blockPos != null) {
    ...
    public void Method536(Class24 class24) {
        block3: {
            ...
            if (!(class24.getPacket() instanceof CPacketPlayer) || this.Field744.Method737(350.0) || !this.Field738.getValue().booleanValue() || this.Field735.getValue() != Class410.VANILLA) break block3;
            ...
            if (class24.getPacket() instanceof CPacketPlayer.Position) {
                ...
                Class319.mc.player.connection.sendPacket(new CPacketPlayer.PositionRotation(cPacketPlayer.getX(Class319.mc.player.posX), cPacketPlayer.getY(Class319.mc.player.posY), cPacketPlayer.getZ(Class319.mc.player.posZ), this.Field742, this.Field743, cPacketPlayer.isOnGround()));
            } else {
    ...
    public boolean Method512(BlockPos blockPos) {
        ...
        return block.getBlockHardness(iBlockState, Class319.mc.world, blockPos) != -1.0f;
    }
    ...
    public void Method135(UpdateEvent updateEvent) {
        block7: {
            ...
            if (this.Field738.getValue().booleanValue() && this.Field745 != null) {
                this.Method789(this.Field745);
            }
            if (this.Field744.Method737(350.0)) break block7;
            if (this.Field738.getValue().booleanValue()) {
