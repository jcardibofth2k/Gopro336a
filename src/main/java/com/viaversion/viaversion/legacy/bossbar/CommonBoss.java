...
import com.viaversion.viaversion.legacy.bossbar.CommonBoss.1;
...
public class CommonBoss implements BossBar {
   ...
   public BossBar setTitle(String title) {
      ...
      this.title = title;
      this.sendPacket(com.viaversion.viaversion.legacy.bossbar.CommonBoss.UpdateAction.UPDATE_TITLE);
      return this;
   }
   ...
   public BossBar setHealth(float health) {
      Preconditions.checkArgument(health >= 0.0F && health <= 1.0F, "Health must be between 0 and 1. Input: " + health);
      this.health = health;
      this.sendPacket(com.viaversion.viaversion.legacy.bossbar.CommonBoss.UpdateAction.UPDATE_HEALTH);
      return this;
   }
   ...
   public BossBar setColor(BossColor color) {
      ...
      this.color = color;
      this.sendPacket(com.viaversion.viaversion.legacy.bossbar.CommonBoss.UpdateAction.UPDATE_STYLE);
      return this;
   }
   ...
   public BossBar addConnection(UserConnection conn) {
      if (this.connections.put(conn.getProtocolInfo().getUuid(), conn) == null && this.visible) {
         this.sendPacketConnection(conn, this.getPacket(com.viaversion.viaversion.legacy.bossbar.CommonBoss.UpdateAction.ADD, conn));
      }
   ...
   public BossBar removePlayer(UUID uuid) {
      ...
      if (client != null) {
         this.sendPacketConnection(client, this.getPacket(com.viaversion.viaversion.legacy.bossbar.CommonBoss.UpdateAction.REMOVE, client));
      }
   ...
   public BossBar addFlag(BossFlag flag) {
      ...
      this.sendPacket(com.viaversion.viaversion.legacy.bossbar.CommonBoss.UpdateAction.UPDATE_FLAGS);
      return this;
   }
   ...
   private void setVisible(boolean value) {
      if (this.visible != value) {
         this.visible = value;
         this.sendPacket(value ? com.viaversion.viaversion.legacy.bossbar.CommonBoss.UpdateAction.ADD : com.viaversion.viaversion.legacy.bossbar.CommonBoss.UpdateAction.REMOVE);
      }
   ...
   private void sendPacket(com.viaversion.viaversion.legacy.bossbar.CommonBoss.UpdateAction action) {
