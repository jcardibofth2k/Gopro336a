...
public class Entity1_12Types {
   public static Entity1_12Types.EntityType getTypeFromId(int typeID, boolean isObject) {
      Optional type;
      if (isObject) {
         type = Entity1_12Types.ObjectType.getPCEntity(typeID);
      } else {
         type = Entity1_12Types.EntityType.findById(typeID);
      }

      if (!type.isPresent()) {
         Via.getPlatform().getLogger().severe("Could not find 1.12 type id " + typeID + " isObject=" + isObject);
         return Entity1_12Types.EntityType.ENTITY;
      } else {
         return (Entity1_12Types.EntityType)type.get();
      }
   }

   public static enum ObjectType implements com.viaversion.viaversion.api.minecraft.entities.ObjectType {
      BOAT(1, Entity1_12Types.EntityType.BOAT),
      ITEM(2, Entity1_12Types.EntityType.DROPPED_ITEM),
      AREA_EFFECT_CLOUD(3, Entity1_12Types.EntityType.AREA_EFFECT_CLOUD),
      MINECART(10, Entity1_12Types.EntityType.MINECART_RIDEABLE),
      TNT_PRIMED(50, Entity1_12Types.EntityType.PRIMED_TNT),
      ENDER_CRYSTAL(51, Entity1_12Types.EntityType.ENDER_CRYSTAL),
      TIPPED_ARROW(60, Entity1_12Types.EntityType.ARROW),
      SNOWBALL(61, Entity1_12Types.EntityType.SNOWBALL),
      EGG(62, Entity1_12Types.EntityType.EGG),
      FIREBALL(63, Entity1_12Types.EntityType.FIREBALL),
      SMALL_FIREBALL(64, Entity1_12Types.EntityType.SMALL_FIREBALL),
      ENDER_PEARL(65, Entity1_12Types.EntityType.ENDER_PEARL),
      WITHER_SKULL(66, Entity1_12Types.EntityType.WITHER_SKULL),
      SHULKER_BULLET(67, Entity1_12Types.EntityType.SHULKER_BULLET),
      LIAMA_SPIT(68, Entity1_12Types.EntityType.LIAMA_SPIT),
      FALLING_BLOCK(70, Entity1_12Types.EntityType.FALLING_BLOCK),
      ITEM_FRAME(71, Entity1_12Types.EntityType.ITEM_FRAME),
      ENDER_SIGNAL(72, Entity1_12Types.EntityType.ENDER_SIGNAL),
      POTION(73, Entity1_12Types.EntityType.SPLASH_POTION),
      THROWN_EXP_BOTTLE(75, Entity1_12Types.EntityType.THROWN_EXP_BOTTLE),
      FIREWORK(76, Entity1_12Types.EntityType.FIREWORK),
      LEASH(77, Entity1_12Types.EntityType.LEASH_HITCH),
      ARMOR_STAND(78, Entity1_12Types.EntityType.ARMOR_STAND),
      EVOCATION_FANGS(79, Entity1_12Types.EntityType.EVOCATION_FANGS),
      FISHIHNG_HOOK(90, Entity1_12Types.EntityType.FISHING_HOOK),
      SPECTRAL_ARROW(91, Entity1_12Types.EntityType.SPECTRAL_ARROW),
      DRAGON_FIREBALL(93, Entity1_12Types.EntityType.DRAGON_FIREBALL);

      private static final Map TYPES = new HashMap();
      // $FF: renamed from: id int
      private final int field_375;
      private final Entity1_12Types.EntityType type;

      private ObjectType(int id, Entity1_12Types.EntityType type) {
         this.field_375 = id;
         this.type = type;
      }
      ...
      public static Optional findById(int id) {
         return id == -1 ? Optional.empty() : Optional.ofNullable((Entity1_12Types.ObjectType)TYPES.get(id));
      }

      public static Optional getPCEntity(int id) {
         Optional output = findById(id);
         return !output.isPresent() ? Optional.empty() : Optional.of(((Entity1_12Types.ObjectType)output.get()).type);
      }

      static {
         Entity1_12Types.ObjectType[] var0 = values();
         int var1 = var0.length;

         for(int var2 = 0; var2 < var1; ++var2) {
            Entity1_12Types.ObjectType type = var0[var2];
            TYPES.put(type.field_375, type);
         }
   ...
   public static enum EntityType implements com.viaversion.viaversion.api.minecraft.entities.EntityType {
      ...
      private static final Map TYPES = new HashMap();
      // $FF: renamed from: id int
      private final int field_3077;
      private final Entity1_12Types.EntityType parent;
      ...
      private EntityType(int id, Entity1_12Types.EntityType parent) {
         this.field_3077 = id;
         this.parent = parent;
      }
      ...
      public Entity1_12Types.EntityType getParent() {
         return this.parent;
      }

      public static Optional findById(int id) {
         return id == -1 ? Optional.empty() : Optional.ofNullable((Entity1_12Types.EntityType)TYPES.get(id));
      }

      static {
         Entity1_12Types.EntityType[] var0 = values();
         int var1 = var0.length;

         for(int var2 = 0; var2 < var1; ++var2) {
            Entity1_12Types.EntityType type = var0[var2];
            TYPES.put(type.field_3077, type);
         }
