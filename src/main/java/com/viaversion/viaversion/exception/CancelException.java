...
import com.viaversion.viaversion.exception.CancelException.1;

public class CancelException extends Exception {
   public static final CancelException CACHED = new 1("This packet is supposed to be cancelled; If you have debug enabled, you can ignore these");
