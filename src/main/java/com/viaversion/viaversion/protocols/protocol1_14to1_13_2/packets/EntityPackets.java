   ...
   public static void register(final Protocol1_14To1_13_2 protocol) {
            ...
            this.handler(new PacketHandler() {
               public void handle(PacketWrapper wrapper) throws Exception {
                  ...
                  if (type1_14 != null) {
                     ...
                     if (type1_14.method_23(Entity1_14Types.FALLING_BLOCK)) {
                        wrapper.set(Type.INT, 0, protocol.getMappingData().getNewBlockStateId(data));
                     } else if (type1_14.method_23(Entity1_14Types.MINECART)) {
                        switch(data) {
                        case 1:
                     ...
                     } else if (type1_14.method_23(Entity1_14Types.ITEM) && data > 0 || type1_14.isOrHasParent(Entity1_14Types.ABSTRACT_ARROW)) {
      ...
      protocol.registerClientbound(ClientboundPackets1_13.ENTITY_ANIMATION, new PacketRemapper() {
         public void registerMap() {
            ...
            this.handler(new PacketHandler() {
               public void handle(PacketWrapper wrapper) throws Exception {
                  short animation = (Short)wrapper.passthrough(Type.UNSIGNED_BYTE);
                  if (animation == 2) {
