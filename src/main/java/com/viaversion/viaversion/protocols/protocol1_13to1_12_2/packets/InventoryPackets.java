            ...
            this.handler(new PacketHandler() {
               public void handle(PacketWrapper wrapper) throws Exception {
                  ...
                  if (channel.equalsIgnoreCase("MC|StopSound")) {
                     ...
                     if (!old.isEmpty()) {
                        flags = (byte)(flags | 1);
                        Optional finalSource = SoundSource.findBySource(old);
         ...
         if (tag != null) {
            ...
            if (tag.get("display") instanceof CompoundTag) {
               ...
               if (entityTag.get("Name") instanceof StringTag) {
                  ...
                  identifier.setValue(ChatRewriter.legacyTextToJsonString(identifier.getValue(), true));
               }
            }
            ...
            if (tag.get("CanPlaceOn") instanceof ListTag) {
               ...
               while(var22.hasNext()) {
                  ...
                  oldId = value.toString().replace("minecraft:", "");
         ...
         if (tag != null) {
            ...
            if (tag.get(NBT_TAG_NAME + "|CanPlaceOn") instanceof ListTag) {
               ...
               while(var23.hasNext()) {
                  oldTag = (Tag)var23.next();
                  value = oldTag.getValue();
                  newValues = (String[])BlockIdData.fallbackReverseMapping.get(value instanceof String ? ((String)value).replace("minecraft:", "") : null);
                  if (newValues != null) {
                     var27 = newValues;
