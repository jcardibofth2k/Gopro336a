...
public class WallConnectionHandler extends AbstractFenceConnectionHandler {
   ...
   protected byte getStates(UserConnection user, Position position, int blockState) {
      ...
      if (this.method_47(user, position)) {
         states = (byte)(states | 16);
      }
   ...
   // $FF: renamed from: up (com.viaversion.viaversion.api.connection.UserConnection, com.viaversion.viaversion.api.minecraft.Position) boolean
   public boolean method_47(UserConnection user, Position position) {
