...
public class ItemRewriter {
   private static final Map ENTTIY_NAME_TO_ID = new HashMap();
   private static final Map ENTTIY_ID_TO_NAME = new HashMap();
   private static final Map POTION_NAME_TO_ID = new HashMap();
   private static final Map POTION_ID_TO_NAME = new HashMap();
   private static final Int2IntMap POTION_INDEX = new Int2IntOpenHashMap(36, 1.0F);
   ...
   public static void toClient(Item item) {
      if (item != null) {
         ...
         if (item.identifier() == 383 && item.data() != 0) {
            ...
            String entityName = (String)ENTTIY_ID_TO_NAME.get(Integer.valueOf(item.data()));
            if (entityName != null) {
