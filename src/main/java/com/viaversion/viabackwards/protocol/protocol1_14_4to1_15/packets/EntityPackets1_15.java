...
public class EntityPackets1_15 extends EntityRewriter {
   ...
   protected void registerPackets() {
         ...
         public void registerMap() {
            ...
            this.handler((wrapper) -> {
               if ((Short)wrapper.get(Type.UNSIGNED_BYTE, 0) == 11) {
                  ((ImmediateRespawn)wrapper.user().get(ImmediateRespawn.class)).setImmediateRespawn((Float)wrapper.get(Type.FLOAT, 0) == 1.0F);
               }
      ...
      this.protocol.registerClientbound(ClientboundPackets1_15.SPAWN_MOB, new PacketRemapper() {
         public void registerMap() {
            ...
            this.handler((wrapper) -> {
               ...
               EntityPackets1_15.this.tracker(wrapper.user()).addEntity((Integer)wrapper.get(Type.VAR_INT, 0), entityType);
      ...
      this.protocol.registerClientbound(ClientboundPackets1_15.JOIN_GAME, new PacketRemapper() {
         public void registerMap() {
            ...
            this.handler((wrapper) -> {
               boolean immediateRespawn = !(Boolean)wrapper.read(Type.BOOLEAN);
   ...
   protected void registerRewrites() {
      ...
      this.mapEntityTypeWithData(Entity1_15Types.BEE, Entity1_15Types.PUFFERFISH).jsonName("Bee").spawnMetadata((storage) -> {
      ...
      this.filter().type(Entity1_15Types.WOLF).index(8).handler((event, meta) -> {
         event.createExtraMeta(new Metadata(17, MetaType1_14.Float, event.meta().value()));
      });
   }
