...
public class EntityPackets1_13 extends LegacyEntityRewriter {
   ...
   protected void registerPackets() {
            ...
            this.handler(new PacketHandler() {
               public void handle(PacketWrapper wrapper) throws Exception {
                  if (ViaBackwards.getConfig().isFix1_13FacePlayer()) {
                     ...
                     byte bitField = (Byte)wrapper.get(Type.BYTE, 0);
      ...
      ((Protocol1_12_2To1_13)this.protocol).registerClientbound(ClientboundPackets1_13.SPAWN_ENTITY, new PacketRemapper() {
         public void registerMap() {
            ...
            this.handler(new PacketHandler() {
               public void handle(PacketWrapper wrapper) throws Exception {
                  Optional optionalType = Entity1_13Types.ObjectType.findById((Byte)wrapper.get(Type.BYTE, 0));
                  if (optionalType.isPresent()) {
                     ...
                     if (type == Entity1_13Types.ObjectType.FALLING_BLOCK) {
                        ...
                        int combined = Protocol1_12_2To1_13.MAPPINGS.getNewBlockStateId(data);
         ...
         public void registerMap() {
            ...
            this.handler(new PacketHandler() {
               public void handle(PacketWrapper wrapper) throws Exception {
                  ...
                  EntityPackets1_13.this.tracker(wrapper.user()).addEntity((Integer)wrapper.get(Type.VAR_INT, 0), entityType);
         ...
         public void registerMap() {
            this.handler(new PacketHandler() {
               public void handle(PacketWrapper wrapper) throws Exception {
                  wrapper.cancel();
                  if (ViaBackwards.getConfig().isFix1_13FacePlayer()) {
                     int anchor = (Integer)wrapper.read(Type.VAR_INT);
                     double x = (Double)wrapper.read(Type.DOUBLE);
                     double y = (Double)wrapper.read(Type.DOUBLE);
                     double z = (Double)wrapper.read(Type.DOUBLE);
                     ...
                     positionAndLook.write(Type.DOUBLE, 0.0D);
                     positionAndLook.write(Type.DOUBLE, 0.0D);
                     positionAndLook.write(Type.DOUBLE, 0.0D);
   ...
   protected void registerRewrites() {
      ...
      this.mapEntityTypeWithData(Entity1_13Types.EntityType.PHANTOM, Entity1_13Types.EntityType.PARROT).mobName("Phantom").spawnMetadata((storage) -> {
      ...
      this.filter().type(Entity1_13Types.EntityType.WOLF).index(17).handler((event, meta) -> {
