...
public class EntityPackets1_11 extends LegacyEntityRewriter {
   ...
   protected void registerPackets() {
      this.protocol.registerClientbound(ClientboundPackets1_9_3.EFFECT, new PacketRemapper() {
         public void registerMap() {
            this.map(Type.INT);
            this.map(Type.POSITION);
            this.map(Type.INT);
            this.handler((wrapper) -> {
               int type = (Integer)wrapper.get(Type.INT, 0);
               if (type == 2002 || type == 2007) {
                  if (type == 2007) {
                     wrapper.set(Type.INT, 0, 2002);
                  }

                  int mappedData = PotionSplashHandler.getOldData((Integer)wrapper.get(Type.INT, 1));
                  if (mappedData != -1) {
      ...
      this.protocol.registerClientbound(ClientboundPackets1_9_3.SPAWN_ENTITY, new PacketRemapper() {
         public void registerMap() {
            ...
            this.handler(EntityPackets1_11.this.getObjectRewriter((id) -> {
      ...
      this.protocol.registerClientbound(ClientboundPackets1_9_3.SPAWN_MOB, new PacketRemapper() {
         public void registerMap() {
            ...
            this.handler((wrapper) -> {
               ...
               List list = (List)wrapper.get(Types1_9.METADATA_LIST, 0);
               EntityPackets1_11.this.handleMetadata((Integer)wrapper.get(Type.VAR_INT, 0), list, wrapper.user());
      ...
      this.protocol.registerClientbound(ClientboundPackets1_9_3.ENTITY_STATUS, new PacketRemapper() {
         public void registerMap() {
            this.map(Type.INT);
            this.map(Type.BYTE);
            this.handler(new PacketHandler() {
               public void handle(PacketWrapper wrapper) throws Exception {
                  byte b = (Byte)wrapper.get(Type.BYTE, 0);
                  if (b == 35) {
                     wrapper.clearPacket();
                     wrapper.setId(30);
   ...
   protected void registerRewrites() {
      ...
      this.mapEntityTypeWithData(Entity1_11Types.EntityType.WITHER_SKELETON, Entity1_11Types.EntityType.SKELETON).mobName("Wither Skeleton").spawnMetadata((storage) -> {
         storage.add(this.getSkeletonTypeMeta(1));
      });
      this.mapEntityTypeWithData(Entity1_11Types.EntityType.STRAY, Entity1_11Types.EntityType.SKELETON).mobName("Stray").spawnMetadata((storage) -> {
         storage.add(this.getSkeletonTypeMeta(2));
      });
      this.mapEntityTypeWithData(Entity1_11Types.EntityType.HUSK, Entity1_11Types.EntityType.ZOMBIE).mobName("Husk").spawnMetadata((storage) -> {
         this.handleZombieType(storage, 6);
      });
      this.mapEntityTypeWithData(Entity1_11Types.EntityType.ZOMBIE_VILLAGER, Entity1_11Types.EntityType.ZOMBIE).spawnMetadata((storage) -> {
         this.handleZombieType(storage, 1);
      });
      this.mapEntityTypeWithData(Entity1_11Types.EntityType.HORSE, Entity1_11Types.EntityType.HORSE).spawnMetadata((storage) -> {
         storage.add(this.getHorseMetaType(0));
      });
      this.mapEntityTypeWithData(Entity1_11Types.EntityType.DONKEY, Entity1_11Types.EntityType.HORSE).spawnMetadata((storage) -> {
         storage.add(this.getHorseMetaType(1));
      });
      this.mapEntityTypeWithData(Entity1_11Types.EntityType.MULE, Entity1_11Types.EntityType.HORSE).spawnMetadata((storage) -> {
         storage.add(this.getHorseMetaType(2));
      });
      this.mapEntityTypeWithData(Entity1_11Types.EntityType.SKELETON_HORSE, Entity1_11Types.EntityType.HORSE).spawnMetadata((storage) -> {
         storage.add(this.getHorseMetaType(4));
      });
      this.mapEntityTypeWithData(Entity1_11Types.EntityType.ZOMBIE_HORSE, Entity1_11Types.EntityType.HORSE).spawnMetadata((storage) -> {
         storage.add(this.getHorseMetaType(3));
      });
      ...
      this.mapEntityTypeWithData(Entity1_11Types.EntityType.VINDICATION_ILLAGER, Entity1_11Types.EntityType.VILLAGER).mobName("Vindicator").spawnMetadata((storage) -> {
         storage.add(new Metadata(13, MetaType1_9.VarInt, 4));
      });
      this.mapEntityTypeWithData(Entity1_11Types.EntityType.LIAMA, Entity1_11Types.EntityType.HORSE).mobName("Llama").spawnMetadata((storage) -> {
         storage.add(this.getHorseMetaType(1));
      });
      ...
      this.filter().type(Entity1_11Types.EntityType.VEX).index(12).handler((event, meta) -> {
