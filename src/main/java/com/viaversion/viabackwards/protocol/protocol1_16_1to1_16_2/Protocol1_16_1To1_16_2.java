...
public class Protocol1_16_1To1_16_2 extends BackwardsProtocol {
   ...
   protected void registerPackets() {
      ...
      this.executeAsyncAfterLoaded(Protocol1_16_2To1_16_1.class, var10002::load);
      ...
      this.registerClientbound(ClientboundPackets1_16_2.CHAT_MESSAGE, new PacketRemapper() {
         public void registerMap() {
            this.handler((wrapper) -> {
               ...
               byte position = (Byte)wrapper.passthrough(Type.BYTE);
               if (position == 2) {
                  wrapper.clearPacket();
         ...
         public void registerMap() {
            this.handler(new PacketHandler() {
               ...
               private void sendSeenRecipePacket(int recipeType, PacketWrapper wrapper) throws Exception {
                  boolean open = (Boolean)wrapper.read(Type.BOOLEAN);
                  boolean filter = (Boolean)wrapper.read(Type.BOOLEAN);
