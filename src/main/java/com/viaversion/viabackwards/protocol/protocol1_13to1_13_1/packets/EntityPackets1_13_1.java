   ...
   protected void registerPackets() {
      ...
      ((Protocol1_13To1_13_1)this.protocol).registerClientbound(ClientboundPackets1_13.SPAWN_MOB, new PacketRemapper() {
         public void registerMap() {
            ...
            this.handler(new PacketHandler() {
               public void handle(PacketWrapper wrapper) throws Exception {
                  List metadata = (List)wrapper.get(Types1_13.METADATA_LIST, 0);
                  EntityPackets1_13_1.this.handleMetadata((Integer)wrapper.get(Type.VAR_INT, 0), metadata, wrapper.user());
               }
            });
         }
      });
